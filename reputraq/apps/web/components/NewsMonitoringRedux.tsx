...
export function NewsMonitoringRedux({ keywords }: NewsMonitoringProps) {
  ...
  return (
    <div ref={newsSectionRef} className={styles.container}>
      {/* Header */}
                      ...
                      <div className={styles.reachItem}>
                        ...
                        <div className={styles.reachContent}>
                          ...
                          <span className={styles.reachValue}>
                            {formatReachNumber(article.estimatedReach.finalEstimatedReach)}
                          </span>
                        </div>
                      </div>
                      <div className={styles.reachDetails}>
                        <span className={styles.reachDetail}>
                          Publication: {formatReachNumber(article.estimatedReach.monthlyReach)}/mo
                        </span>
                        <span className={styles.reachDetail}>
                          Range: {article.estimatedReach.reachRange}
                        </span>
                      </div>
                    </div>
                  )}
